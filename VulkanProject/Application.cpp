...
void Application::recordCommandBuffer(VkCommandBuffer commandBuffer, uint32_t imageIndex)
{
    ...
    vkCmdBindVertexBuffers(commandBuffer, /*firstBinding*/0, /*bindingCount*/1, &vertexBuffer, &zero);
    ...
    VkBuffer particleVB = shaderStorageBuffers[currentFrame];
    vkCmdBindVertexBuffers(commandBuffer, 0, 1, &particleVB, &zero);
...
{
    ComputeUBO udo{};
    udo.deltaTime = lastFrameTime * 2.0f;

    memcpy(uniformBuffersMapped[currentImage], &udo, sizeof(udo));
